...
- **Whether the PolarizationAnalyzer family graduates.** It is a loose family on its second sighting, held under review (POL-2). i10 records HOLD; the graduate-or-hold call is human and is not made here. The analyzer crystal values stay uninvented behind that hold. The `Magnet` family has since graduated (i10-1 was one of its three consumers with 4-ID and ID32); only the per-Asset magnet field values stay uninvented (MAG-1).
